...
?>        
	...
	{ ?>
		...
		foreach ($posts->result() as $post)
		{
			...
			$PostDesc = character_limiter($post->dbPostDesc, 75);
		...
		?>
          ...
          <li class="clearfix css3">
            <div class="image css3"><img src="<?=base_url()?>/img/categories/feed/<?=$category->dbCatCnt?>.fw.png" alt="battle" class="css3" /></div>
            <div class="details">
