<?php
	...
	<div class="content">
		<div class="signup">
    	<form action="betaregister.php" method="post">
        	<table>
            	<tr>
                ...
                <tr>
                	<td>&nbsp;</td>
                   	<td class="terms"><div class="check"><input type="hidden" value="no" name="terms"/></div><p style="float:left; margin:0px 0 0 16px;">I understand and agree with the<br />Choicr <a href="../terms/">Terms of Service</a>.</p></td>
              	</tr>
                <tr>
                	<td>&nbsp;</td>
