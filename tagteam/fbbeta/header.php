...
<head>
	...
	<?php //Added by progSides - 2011-04-09 @10:41PM EDT
		if(isset($_REQUEST['sort'])):
		 echo "var sortIs = '".$_REQUEST['sort']."';";
		else:
			echo "var sortIs = 'recent';";
		endif;
		
		if(isset($nowForAutoBlender)):
			echo "var autoBlendLastLoad = '".$nowForAutoBlender."';";
		endif;
	?>
	var timeUntilAutoBlender = 60000;
	
	</script>
	<script src='../js/autoBlender.js'></script>
