...
var Validate = {
   ...
   *                           (DEFAULT: false)
    ...
    Exclusion: function(value, paramsObj){
      var paramsObj = paramsObj || {};
    	paramsObj.failureMessage = paramsObj.failureMessage || "I, O, and Q are not part of a valid VIN number";
    ...
    Confirmation: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Please make sure your password entries match";
